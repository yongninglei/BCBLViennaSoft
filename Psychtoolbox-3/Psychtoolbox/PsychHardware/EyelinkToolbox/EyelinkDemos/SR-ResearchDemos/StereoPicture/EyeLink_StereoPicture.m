...
try
    ...
    imgList = {'img1Left.bmp' 'img1Right.bmp'; 'img2Left.bmp' 'img2Right.bmp'};% Provide image list for 2 trials
    for i = 1:size(imgList,1)
        ...
        for itScr = 0:1 % iterate through left/right eye windows
            ...
            imgName = char(imgList(i,itScr+1)); % Get left image file name for current trial
