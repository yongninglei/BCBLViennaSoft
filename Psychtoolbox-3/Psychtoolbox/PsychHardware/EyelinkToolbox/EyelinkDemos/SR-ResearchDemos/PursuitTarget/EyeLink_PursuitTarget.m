...
try
    ...
    sinePlotX = width/2; % X centre of target sinusoidal pattern (screen centre by default)
    sinePlotY = height/2; % Y centre of target sinusoidal pattern (screen centre by default)
    amplitudeX = width/3; % X amplitude of sinusoidal pattern [pixels]
    amplitudeY = height/3; % Y amplitude of sinusoidal pattern [pixels]
