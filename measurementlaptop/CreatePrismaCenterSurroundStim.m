function CreatePrismaCenterSurroundStim(ScotomaBorderAngle,TR,TriggerKey,Eyetracker)
% create some default parameters
params = retCreateDefaultGUIParams;

% modify them
params.experiment       =  'center-surround with blanks';%'full-field, on-off'; %Edit Size in retSetExperimentParams
...
params.period           =  18;%18; %Period of on+off -> For TR=1.5 20 is automatically changed to 19.5
params.numCycles        =  10; %How often is the Stimulus presented during one run
...
params.MaxRadius        =  9.4; %Real maximum angle
params.ScotomaBorderAngle    =  ScotomaBorderAngle;
params.triggerKey       =  TriggerKey;%'6'; % For different trigger device see pressKey2Begin.m
%params.trigger          = '5';
...
if Eyelink('IsConnected') && Eyetracker==1
