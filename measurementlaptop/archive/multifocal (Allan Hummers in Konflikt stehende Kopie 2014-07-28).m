...
% %params.savestimparams   =  0;
 ...
 params.period           =  279; % 186 scans; 232.5; 155 scans
 params.numCycles        =  1;
 ...
 params.tr               =  1.5;
 %params.loadMatrix       =  [];
 params.loadMatrix       =  ['/Users/macintosh/Stimulus Dropbox/Dropbox/measurementlaptop/images/',mfilename,'_images.mat'];%['/Users/allan/Dropbox/measurementlaptop/images/',mfilename,'_images.mat'];
 params.saveMatrix       =  [];
