...
expNames = {...
    ...
    'stationary double-wedge, on-off, 45',...
    'multifocal'};
...
switch expName
    ...
    case 'rotating wedge (45deg duty)',
        ...
        params.wedgeDeg = 45;
        params.seqDirection = 0;
        if isfield(params,'CustomInnerRad'); params.innerRad = params.CustomInnerRad*params.radius;else params.innerRad = 0; end
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
...
%         params.numSubRings = (params.radius)/(2*params.subRingDeg);
      ...
      case 'center-surround',
        ...
        OneDegree=params.radius/params.MaxRadius;
        RingBorder=OneDegree*params.ScotomaBorderAngle;
        
        params.stimSize  
        params.type = 'center-surround';
        params.centerInnerRad = 0;
        params.centerOuterRad = RingBorder-OneDegree;
        params.surroundInnerRad = RingBorder+OneDegree;%14;
        params.surroundOuterRad = 20;
        params.numImages = 2;
        params.duration = params.period/params.numImages;
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
        
     case 'center-surround with blanks',
        OneDegree=params.radius/params.MaxRadius;
        RingBorder=OneDegree*params.ScotomaBorderAngle;
    ...
    case 'stationary bottom wedge, on-off, 45',
        params.type = 'stationary-bottom-wedge-on-off';
        params.wedgeDeg = 45;
        params.numImages = 2;
        params.duration = params.period/params.numImages;
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
        
    case 'stationary top wedge, on-off, 45',
        params.type = 'stationary-top-wedge-on-off';
        params.wedgeDeg = 45;
        params.numImages = 2;
        params.duration = params.period/params.numImages;
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
    ...
    case 'stationary double-wedge, on-off, 45',
        params.type = 'stationary-double-wedge-on-off';
        params.wedgeDeg = 45;
        params.numImages = 2;
        params.duration = params.period/params.numImages;
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
        
    case 'stationary double-wedge, on-off, half left 45',
        params.type = 'stationary-double-wedge-on-off-halfleft';
        params.wedgeDeg = 45;
        params.numImages = 2;
        params.duration = params.period/params.numImages;
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
        
    case 'stationary double-wedge, on-off, half right 45',
        params.type = 'stationary-double-wedge-on-off-halfright';
        params.wedgeDeg = 45;
        params.numImages = 2;
        params.duration = params.period/params.numImages;
        params.numSubRings = (params.radius)/(2*params.subRingDeg);
