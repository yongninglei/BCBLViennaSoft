...
% Warning - Big red exclamation mark will appear instead of error
...
%For Video Recording:
% [displayID.windowPtr,displayID.rect] = Screen('OpenWindow',displayID.screenNumber,...
%     displayID.backColorRgb, [1280+1 0 1280*2-1 1024], displayID.bitsPerPixel, numBuffers);
% display(['[',mfilename,'] line 124'])       
