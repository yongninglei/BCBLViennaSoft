...
% %params.savestimparams   =  0;
 ...
 params.tr               =  1.5;
 %params.loadMatrix       =  [];
 params.loadMatrix       =  ['/Users/fmri/Dropbox/measurementlaptop/images/',mfilename,'_images.mat'];%['/Users/allan/Dropbox/measurementlaptop/images/',mfilename,'_images.mat'];
 params.saveMatrix       =  [];
