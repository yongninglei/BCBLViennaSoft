function CheckRealFoV(RingDirection)
...
% modify them
if strcmp(RingDirection,'expanding')
    params.experiment       =  'expanding ring (45% duty)';
    params.DrawFirstTexture = 1;
elseif strcmp(RingDirection,'contracting')
    params.experiment       =  'contracting ring (45% duty)';
end
...
params.period           =  160 %5*32 - step size is 9.4/32 degrees  ;%35%280;%288; %In Reality the stimulus is 336 seconds long, because of the 4 * 12s long blanks which are inserted after each diagonal;
...
params.stimSize         =  'max';%5%5.5;%'max';%6;9
params.FixationandBackgroundSize = 5;
params.triggerKey       =  '6';%'6'; % For different trigger device see pressKey2Begin.m
%params.trigger          = '5';
